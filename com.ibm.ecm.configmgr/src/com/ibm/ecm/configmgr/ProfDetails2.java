...
public class ProfDetails2 extends javax.swing.JFrame {
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    	//"DB2 Universal JDBC Driver", "DB2 for z/OS Universal JDBC Driver", 
    	//"DB2 Universal JDBC Driver (pureScale)", "DB2 Universal JDBC Driver (HADR)", 
    	...
    	if(dbType.equals("Oracle JDBC Driver"))
    		...
    		CMUtil.dbType = "db2zos";
    	else if(dbType.equals("DB2 Universal JDBC Driver (pureScale)"))
    		CMUtil.dbType = "db2ps";
    	else if(dbType.equals("DB2 Universal JDBC Driver (HADR)"))
    		CMUtil.dbType = "db2hadr";
    	else if(dbType.equals("Oracle JDBC Driver (RAC support)"))
    		CMUtil.dbType = "oracle_rac";
    	else if(dbType.equals("Oracle JDBC Driver (SSL enabled)"))
    		CMUtil.dbType = "oracle_ssl";
    	else
    		System.out.println("Wrong selection");
